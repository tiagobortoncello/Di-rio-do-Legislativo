...
def run_app():
    ...
    st.title("Extrator de Documentos PDF")
    st.markdown("Faça o upload de um arquivo PDF para extrair normas, proposições, requerimentos e pareceres.")
    st.divider()
    ...
    if uploaded_file is not None:
        ...
        # ==========================
        # ABA 4: Pareceres (Emendas / Substitutivos)
        # ==========================
        found_projects = {}
